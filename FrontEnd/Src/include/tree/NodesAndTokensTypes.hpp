...
static const DefaultMainInfo DefaultMainInfoArr[] =
{
    {START, STRLEN(START), MainStartEnd::start},
    {END  , STRLEN(END)  , MainStartEnd::end} ,
};

//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

static const size_t DefaultMainInfoArrSize = sizeof(DefaultMainInfoArr) / sizeof(DefaultMainInfoArr[0]);
