...
#define _ASG_VAR(  node,      left           ) do { NodeData_t data = {.init     = Initialisation::assign_variable};TREE_ASSERT(NodeCtor(node, NodeArgType::initialisation, data,  left,          nullptr)); }         while(0)
